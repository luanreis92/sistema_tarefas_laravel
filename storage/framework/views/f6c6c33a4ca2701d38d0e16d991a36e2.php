...
<div class="row">
    ...
    <?php if(sizeof($tarefas)==0): ?>
        <div class="alert alert-danger" role="alert">
            NÃO FOI LOCALIZADO NADA PARECIDO COM ISSO
        </div>
    <?php endif; ?>
    ...
    <?php $__currentLoopData = $tarefas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tarefa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="card col-3 m-3">
            ...
            <div class="card-body">
                ...
                <form action="/editar/<?php echo e($tarefa->id); ?>" method="get">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projetos\Luan\04_Wanderson\meusite\resources\views/welcome.blade.php ENDPATH**/ ?>